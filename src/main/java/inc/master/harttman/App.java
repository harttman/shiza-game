...
public class App {
    ...
    private static final String[] SCENARIO = {
            ...
            "Але йшов час і за декілька днів все перетворились в кошмар, люди стало масово хворити, і це все переростало в пандемію.",
            ...
            "Ознаки які були помічені: Спочатку грипп, потім грипп посилюється і утворюється пневонія, воно викликає подразненя бронх і кровообігу, тому с часом вени, артерії та сухожилля швидко теж \"захворівають\", потім вірус побирається до нервової системи але не вбиває носія, робить з нього овоча. Хоча нервова система дуже хорошому стані, ми наблюдаєм втрату памяті, не спроможність рахути читати писати, навіть ходити.",
